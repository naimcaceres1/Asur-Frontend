...
import { DashboardMisReservasInscripcionesChartClient } from "@/components/dashboard-mis-reservas-inscripciones-chart-client";
    ...
    <div className="flex flex-1 flex-col">
      <div className="@container/main flex flex-1 flex-col gap-2">
        <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6">
          <SectionCardsWrapper role={userRole} />

          {isSocioOrNoSocio && (
            <div className="px-4 lg:px-6">
              <DashboardMisReservasInscripcionesChartClient />
            </div>
          )}
...
export const metadata = {
  title: "Inicio | ASUR",
  description: "Panel principal de la plataforma ASUR",
};
